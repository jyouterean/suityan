...
GitHub Actionsで1日15回自動投稿する、軽貨物ドライバー「すいちゃん」のX/Twitterボットです。

## 概要

- **キャラクター**: すいちゃん（23歳、大久保在住、Amazon系軽貨物ドライバー）
- **投稿頻度**: 1日15回（GitHub Actions cron）
...
| スロット | 時間帯(JST) | トーン |
|---------|------------|-------|
| morning | 6-7時 | 寝起きの一言（1日1回） |
| delivery | 9-11, 14-17時 | 仕事中愚痴＋軽い恋愛妄想 |
| commute | 8, 18時 | 帰宅/移動の寂しさ |
| casual | 8, 12-13, 19-20時 | 日常つぶやき（軽貨物ワード不要） |
| night_ero | 21-22時 | 夜の寂しさ＋軽い誘い（露骨禁止） |
| goodnight | 23-0時 | 甘えたおやすみ（1日1回） |
| simple_goodnight | 23-0時 | 一言おやすみ（1日1回） |
